        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={rememberBox}>
            <input
              ...
              style={checkboxStyle}
            />
            <label htmlFor="remember_reg" style={rememberLabel}>
...
const cardStyle: React.CSSProperties = {
  width: '100%', maxWidth: 450, background: 'rgba(255,255,255,0.04)', backdropFilter: 'blur(40px)', WebkitBackdropFilter: 'blur(40px)',
...
const cardFooter: React.CSSProperties = {
  textAlign: 'center', marginTop: 28, fontSize: 10, color: 'rgba(255,255,255,0.12)', letterSpacing: '0.15em', fontWeight: 600,
}
